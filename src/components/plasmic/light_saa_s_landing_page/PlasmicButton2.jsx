...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: Cc1t0uZIOcx/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: n1pdwQfCCMvqus/icon
import Icon38Icon from "./icons/PlasmicIcon__Icon38"; // plasmic-import: oLcQippjx8W/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__xh59G)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon38Icon
                className={classNames(projectcss.all, sty.svg__x3C3I)}
                role={"img"}
              />
            ),
