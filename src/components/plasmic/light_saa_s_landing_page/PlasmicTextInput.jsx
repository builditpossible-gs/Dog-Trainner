...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: SlEtZvoCOog5nH/css
import Searchsvg2Icon from "./icons/PlasmicIcon__Searchsvg2"; // plasmic-import: cmr6ahYUzZIjvJ/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: n1pdwQfCCMvqus/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Searchsvg2Icon
                className={classNames(projectcss.all, sty.svg___0NCm)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__vbxtP)}
                role={"img"}
              />
            ),
