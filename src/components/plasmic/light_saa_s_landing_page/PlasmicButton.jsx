...
import sty from "./PlasmicButton.module.css"; // plasmic-import: KMBJmHNsD0xfZo/css
import ChevronRightIcon from "./icons/PlasmicIcon__ChevronRight"; // plasmic-import: n0_8zBzdfJ9LE4/icon
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__gKqxu)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__yir1A)}
                role={"img"}
              />
            ),
